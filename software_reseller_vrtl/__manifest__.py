...
{
    'name': 'Industry-vrtl: Software Reseller, Vertel',
    'version': '1.0.0',
    # Version ledger: 14.0 = Odoo version. 1 = Major. Non regressionable code. 2 = Minor. New features that are regressionable. 3 = Bug fixes
    'summary': 'Software Reseller, Vertel',
    'category': 'Industries',
    'description': """
    Software Reseller, Vertel Style
    ...
    #'sequence': '1'
    'author': 'Vertel AB',
    'website': 'https://vertel.se/apps/odoo-industry-vrtl/software_reseller_vrtl',
